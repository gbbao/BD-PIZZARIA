...
VALUES ('irineu1','ANDAMENTO')


-----------------------------------------------------------------
-- SELECT 
--------------------------------
SELECT * FROM PEDIDO_VENDA WHERE COD_CLIENTE LIKE '%gb%';

SELECT * FROM VENDEDOR WHERE COD_VENDEDOR LIKE '%slg%';

SELECT * FROM PRODUTO WHERE COD_PRODUTO LIKE '%20%';

SELECT * FROM TIPO_PRODUTO WHERE COD_TIPO_PRODUTO LIKE '%20%';

SELECT * FROM ITEM_PEDIDO_VENDA WHERE COD_ITEM_PEDIDO_VENDA LIKE '%Pizza%';

SELECT * FROM ITEM_PEDIDO_COMPRA WHERE COD_ITEM_PEDIDO_COMPRA LIKE '%20%';

SELECT * FROM PEDIDO_COMPRA WHERE LIKE COD_PEDIDO_COMPRA '20%';

SELECT * FROM COTACAO WHERE COD_COTACAO LIKE '30%';

SELECT * FROM CLIENTE WHERE COD_CLIENTE LIKE '24%';

SELECT * FROM FORNECEDOR WHERE COD_FORNECEDOR LIKE '%20%';

SELECT * FROM FORMA_PAGAMENTO WHERE COD_FORMA_PAGAMENTO LIKE '%elo%';

SELECT * FROM SITUACAO_PEDIDO WHERE COD_SITUACAO_PEDIDO LIKE '%irineu1%';
